# KikisenTalk
FFXIVのマクロに書いたテキストをDiscordに送信する機能です。  

例えば聞き専が戦闘中にマクロを実行することで、Discordの音声読み上げを介してパーティーメンバーに伝えることができます。  
他にもマクロにFFXIVの /wait コマンドを挟むことで、パーティーメンバーでちょっとしたタイムラインを共有することにも使えます。
...
* [Plugins]→[Kikisen Talk]タブの[Webhook url]テキストボックスに、Discordの WEBHOOK URL をセットします。  
（WEBHOOK URLについては後述します）
2. FFXIV側でマクロにメッセージを登録して実行します。  
<img src= "https://github.com/furutto/KikisenTalk/blob/master/resources/image/readme_add_macro.png" width="600px">  
